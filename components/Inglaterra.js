...
const Inglaterra = () => {
  ...
  return (
    <svg
      ...
      viewBox="0 0 540 325"
      className={styles.inglaterra}
    >
      <path className={styles.inglaBlue} d="M0 0h540v325H0z" />
      <path
        className={styles.inglaWhite}
      ...
      <path className={styles.inglaRed} d="M540 131.3H305.2V0h-70.8v131.3H0v64.8h234.4V325h70.8V196.1H540z" />
    </svg>
  );
};
